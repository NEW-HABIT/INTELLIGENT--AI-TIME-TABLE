...
import { GraduationCap, LogOut, ChevronRight, Menu, X, Bell, FileSpreadsheet } from "lucide-react";
import { useAuthStore } from "@/store/auth";
import { toast } from "sonner";
import { apiClient } from "@/lib/api";

const navItems = [
  { href: "/student/schedule", icon: FileSpreadsheet, label: "My Schedule" },
];
          ...
          >
            ...
            <div className="flex items-center gap-3 px-5 py-5 border-b border-white/10">
              ...
              <div className="min-w-0">
                ...
                <p className="text-white/40 text-xs truncate">Student Portal</p>
              </div>
            </div>
